@component('components.sidebar-wrapper')
	...
	<div class="container-fluid">
          ...
          <!-- Page Heading -->
            <h1 class="h3 mb-0 text-gray-800">New Contact</h1>
		<p></p>
		
		<div class="card shadow mb-4">
			<div class="card-body">
				{{Form::open(['url'=>route('clients.contacts.store',$client),'method'=>'POST'])}}
				...
				<fieldset>
					...
					<div class="form-group">
						...
						{{Form::select('phones[0][type]',array_combine(['office','mobile'],['office','mobile']),null,['class'=>$errors->has('phones[0][type]')?"form-control is-invalid":"form-control"])}}
				...
				<fieldset>
					...
					<div class="form-group">
						...
						{{Form::select('emails[0][type]',array_combine(['work','personal'],['work','personal']),null,['class'=>$errors->has('emails[0][type]')?"form-control is-invalid":"form-control"])}}
